...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final userName = profileAsync.asData?.value?.fullName;
    final greetingName = (userName != null && userName.isNotEmpty) ? userName : AppStrings.t(isArabic, 'role_guest');

    final categories = [
      {'icon': Icons.king_bed_outlined, 'key': 'hotels', 'color': AppColors.ink, 'typeAr': 'فندق', 'typeEn': 'Hotel'},
      {'icon': Icons.apartment_rounded, 'key': 'apartments', 'color': AppColors.secondary, 'typeAr': 'شقة فندقية', 'typeEn': 'Apartment'},
      {'icon': Icons.beach_access_rounded, 'key': 'resorts', 'color': AppColors.goldDark, 'typeAr': 'منتجع', 'typeEn': 'Resort'},
      {'icon': Icons.cabin_outlined, 'key': 'chalets', 'color': AppColors.success, 'typeAr': 'شاليه', 'typeEn': 'Chalet'},
    ];
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text('${AppStrings.t(isArabic, 'hello')}, $greetingName 👋',
                          ...
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (_) => SearchScreen(
                                initialTypeAr: cat['typeAr'] as String,
                                initialTypeEn: cat['typeEn'] as String,
                              ),
                            ),
                          );
                        },
