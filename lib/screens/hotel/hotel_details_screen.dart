              ...
              Padding(
                ...
                child: _CircleIconButton(
                  ...
                  onTap: () async {
                    ...
                    try {
                      await ref.read(favoritesRepositoryProvider).toggle(hotel.id, wasFavorite);
                    } catch (_) {
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      final query = Uri.encodeComponent('${hotel.name} ${hotel.city(isArabic)}');
                      launchUrl(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () => Navigator.of(context).push(
                          MaterialPageRoute(builder: (_) => AllReviewsScreen(hotelId: hotel.id)),
                        ),
                        child: Text(AppStrings.t(isArabic, 'see_all_reviews')),
                      ),
                    ],
                  ),
                  Consumer(
                    builder: (context, ref, _) {
                      final reviewsAsync = ref.watch(hotelReviewsProvider(hotel.id));
                      final reviewableAsync = ref.watch(reviewableBookingProvider(hotel.id));
                            ...
                            data: (reviews) {
                              if (reviews.isEmpty) {
                                return Padding(
                                  ...
                                  child: Text(AppStrings.t(isArabic, 'no_reviews_yet'),
                              ...
                              return Column(
                                children: preview.map((r) {
                                  ...
                                  final displayName =
                                      (name == null || name.isEmpty) ? AppStrings.t(isArabic, 'role_guest') : name;
                                  return Padding(
                              ...
                              return Padding(
                                ...
                                child: OutlinedButton.icon(
                                  onPressed: () async {
                                    ...
                                    if (done == true) {
                                      ref.invalidate(hotelReviewsProvider(hotel.id));
                                      ref.invalidate(reviewableBookingProvider(hotel.id));
                                    }
                                  },
                                  icon: const Icon(Icons.rate_review_outlined, size: 16),
                                  label: Text(AppStrings.t(isArabic, 'write_review')),
                                ),
                              );
                            },
                          ),
