...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final displayName = profile?.fullName.isNotEmpty == true ? profile!.fullName : AppStrings.t(isArabic, 'role_guest');
    final displayPhone = profile?.phone ?? profile?.email ?? '';
                  ...
                  onTap: () => Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (_) => ComingSoonScreen(
                        icon: Icons.credit_card_outlined,
                        title: AppStrings.t(isArabic, 'payment_methods'),
                      ),
                    ),
                  ),
                ),
