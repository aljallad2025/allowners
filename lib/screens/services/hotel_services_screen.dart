                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(AppStrings.t(isArabic, 'no_active_booking'),
                          style: textTheme.titleMedium, textAlign: TextAlign.center),
                      const SizedBox(height: 6),
                      Text(AppStrings.t(isArabic, 'no_active_booking_desc'),
            ...
            final services = [
              ...
              (
                ...
                builder: (BuildContext context) =>
                    MealRequestScreen(hotelId: booking.hotelId, bookingId: booking.id),
              ),
              (
