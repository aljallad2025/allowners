class AppStrings {
  ...
  static const Map<String, Map<String, String>> _strings = {
    ...
    // نظام الصلاحيات والموظفين
    'staff_management': {'ar': 'إدارة الموظفين', 'en': 'Staff Management'},
    'invite_staff': {'ar': 'دعوة موظف جديد', 'en': 'Invite Staff'},
    'role': {'ar': 'الدور', 'en': 'Role'},
    'permissions': {'ar': 'الصلاحيات', 'en': 'Permissions'},
    'commission_rate_percent': {'ar': 'نسبة العمولة (%)', 'en': 'Commission Rate (%)'},
    'active': {'ar': 'نشط', 'en': 'Active'},
    'suspended': {'ar': 'موقوف', 'en': 'Suspended'},
    'suspend': {'ar': 'إيقاف', 'en': 'Suspend'},
    'activate': {'ar': 'تفعيل', 'en': 'Activate'},
    'confirm_delete': {'ar': 'متأكد من الحذف؟', 'en': 'Are you sure you want to delete?'},
    'delete': {'ar': 'حذف', 'en': 'Delete'},
    'no_staff_yet': {'ar': 'ما في موظفين مضافين بعد', 'en': 'No staff members added yet'},

    // عمولات وكيل الحجوزات
    'my_commission': {'ar': 'عمولتي', 'en': 'My Commission'},
    'paid_commission': {'ar': 'مدفوعة', 'en': 'Paid'},
    'pending_commission': {'ar': 'قيد الانتظار', 'en': 'Pending'},
    'new_booking': {'ar': 'حجز جديد', 'en': 'New Booking'},
    'select_unit': {'ar': 'اختر الوحدة', 'en': 'Select Unit'},
    'guest_name': {'ar': 'اسم الضيف', 'en': 'Guest Name'},
    'guest_phone': {'ar': 'رقم جوال الضيف', 'en': 'Guest Phone'},

    // الصيانة والتدبير المنزلي
    'housekeeping_status': {'ar': 'حالة التنظيف', 'en': 'Housekeeping Status'},
    'add_request': {'ar': 'إضافة بلاغ', 'en': 'Add Request'},
    'ready': {'ar': 'جاهزة', 'en': 'Ready'},
    'cleaning': {'ar': 'قيد التنظيف', 'en': 'Cleaning'},
